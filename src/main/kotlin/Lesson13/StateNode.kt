...
class StateNode (
    ...
    fun getNextState(event: GameEvent): TrainingState?{
        ...
        // В котлин можно в роли ключа легко положить какой-либо класс
        // Но если мы хотим положить в роли ключи тип данных: "Наследников класса иерархии" для чего мы и использовали out
        // То это в котлине не реализовано, но есть в Java

        // return transitions[event::class.java]
        // "Возьми тип событие, которое пришло, найди в таблице переходов, состояние, в которое мы должны перейти и верни его"
    }
}
